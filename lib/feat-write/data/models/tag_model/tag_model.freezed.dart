...
class _$TagImpl with DiagnosticableTreeMixin implements _Tag {
  ...
  String toString({DiagnosticLevel minLevel = DiagnosticLevel.info}) {
    return 'Tag(id: $id, name: $name, createdDate: $createdDate, updatedDate: $updatedDate, isEnabled: $isEnabled, worksTotal: $worksTotal)';
  }
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    properties
      ...
      ..add(DiagnosticsProperty('worksTotal', worksTotal));
  }
  ...
  int get hashCode => Object.hash(
      runtimeType, id, name, createdDate, updatedDate, isEnabled, worksTotal);
